...
**Note from Dec 2022**: The code here work beautifully and should hopefully continue to do so for a long time. But I no longer maintain this project. I would be happy to chat or email to help anyone who wants to dive in. For the biggest potential improvement, see this issue: https://github.com/tbenthompson/cutde/issues/23
